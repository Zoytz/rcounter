    ...
    return createPortal(
      <div className="congrats__container">
        <div className="congrats__main">
          ...
          <p className="congrats__text congrats__text_type_first">
            Хочу пожелать тебе - всегда оставаться такой яркой, красивой, позитивной!
          </p>
          <p className="congrats__text congrats__text_type_second">
            Ты - невероятно добрый человек. Оставайся такой и пусть тебе встречаются только такие же добрые люди!
          </p>
          <p className="congrats__text congrats__text_type_third">
            И я знаю - ты очень любишь свою работу. Пусть от количества заказов перегревается твой телефон! А чтобы ты не тратила свое драгоценное время на расчеты - существует это приложение. Оно будет становиться только лучше, в том числе - благодаря тебе.
          </p>
          <h3 className="congrats__congratulations">
